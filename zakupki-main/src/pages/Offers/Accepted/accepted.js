...
import AcceptedColumns from "./AcceptedColumns"
import AcceptedModal from "./AcceptedModal";
import { getOfferAccepted } from "../../../store/offers/actions"
...
class Accepted extends Component {
    ...
    componentDidMount() {
        const { onGetAcceptedOffers } = this.props
        onGetAcceptedOffers()
    }
        ...
        return (
            <React.Fragment>
                ...
                <div className="page-content">
                    <Container fluid>
                        <Breadcrumbs title="Мои предложения" breadcrumbItem="Одобрено" />
                        <Row>
                            <Col xs="12">
                                <Card>
                                    <CardBody>
                                        ...
                                        >
                                            {({ paginationProps, paginationTableProps }) => (
                                                <ToolkitProvider
                                                    keyField="id"
                                                    data={offers || []}
                                                    columns={AcceptedColumns(this.toggleModal)}
                                                    bootstrap4
                                                    search
                                                >
                                                    {toolkitProps => (
...
Accepted.propTypes = {
    ...
    onGetAcceptedOffers: PropTypes.func,
}
...
const mapDispatchToProps = dispatch => ({
    onGetAcceptedOffers: () => dispatch(getOfferAccepted()),
})
